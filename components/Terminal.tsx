...
const Terminal = () => {
  ...
  const codeLines: CodeLines = useMemo(() => ({
    python: [
      'print("Hello, World! 👋 I\'m Saideep Samineni")',
      'print("Current status: CS graduate student at Northeastern University")',
      'print("Professional Summary: Software Engineer with 2+ years of experience in the FinTech industry. Skilled in implementing AI-based microservices using Java, Python, SQL, Javascript, Docker, and AWS.")'
    ],
    javascript: [
      'console.log("Hello, World! 👋 I\'m Saideep Samineni");',
      'console.log("Current status: CS graduate student at Northeastern University");',
      'console.log("Professional Summary: Software Engineer with 2+ years of experience in the FinTech industry. Skilled in implementing AI-based microservices using Java, Python, SQL, Javascript, Docker, and AWS.");'
    ]
  }), []);
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-primary">deep@portfolio:~$</span>
